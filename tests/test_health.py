...
def test_returns_false_when_server_unreachable():
    reset_cache()
    # Port 99999 is out of range; connection will be refused immediately
    result = check_apfel_health(base_url="http://localhost:99999")
...
def test_caches_result_within_cache_window():
    ...
    result1 = check_apfel_health(base_url="http://localhost:99999")
    ...
    result2 = check_apfel_health(base_url="http://localhost:99999")
...
def test_cache_expires_after_ttl(monkeypatch):
    ...
    check_apfel_health(base_url="http://localhost:99999")
